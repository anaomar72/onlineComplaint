...
<Header/>
    ...
    <div className="min-h-screen bg-neutral-400 flex items-center justify-center p-6">
      <form 
      ...
      >
        ...
        <button onClick={handleNote}
          type="submit"
          className="w-full bg-neutral-300 text-white font-bold py-3 px-4 rounded-md hover:from-teal-600 hover:to-cyan-600 transition-colors"
        >
          Save Note
        </button>
      </form>
