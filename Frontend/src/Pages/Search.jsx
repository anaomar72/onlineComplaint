            ...
            <div className="container mx-auto py-8 px-4">
                ...
                <div className="flex justify-center mb-6">
                    <form className="flex flex-col items-center w-full sm:w-[500px] mx-auto">
                        ...
                        <button 
                            onClick={getNote} 
                            className={`w-full py-3 text-white rounded-lg transition-colors  'bg-teal-400' : 'bg-teal-500 hover:bg-teal-600'}`}
                        ...
                        note.Title == title ? (
                            <div className="bg-white p-6 rounded-lg shadow-md mx-auto max-w-2xl">
                                ...
                                <div className="mb-4">
                                    ...
                                    <p className="text-gray-700">{note.describtion}</p>
                                </div>
                            </div>
                        ) : (
                            <p className="text-center text-red-500">No data found for the given title</p>
                        )
                    ) : (
                        <p className="text-center text-black">Please enter a title to search for results.</p>
                    )}
                </div>
            </div>
        </div>
